...
export default class InteractionManager extends React.PureComponent<Props> {
   ...
   */
  distance = (a: PIXI.Point, b: PIXI.Point) =>
    Math.sqrt(Math.pow(a.x - b.x, 2) + Math.pow(a.y - b.y, 2))

  /**
   * Sets DOM body style pointerEvents to 'none' to prevent global mouse events.
   * Paired with {@link InteractionManager#restoreGlobalMouseEvents|restoreGlobalMouseEvents}.
   * @method
   * @returns {undefined}
   */
   ...
   * Paired with {@link InteractionManager#preventGlobalMouseEvents|preventGlobalMouseEvents}.
   * @method
   * @returns {undefined}
   */
  ...
  /**
   * Handles whenever someone scrolls the mouse wheel.
   * We generate the zoom factor,
   * and prevent the website from reacting normally to a mouse scroll (scolling down the page).
   * @method
